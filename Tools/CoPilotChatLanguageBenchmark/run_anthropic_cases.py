#!/usr/bin/env python3
"""Run HAVEN Co-Pilot chat benchmark cases through Anthropic Messages API."""
...
def main(argv: list[str]) -> int:
    ...
    with args.out.open("w", encoding="utf-8") as out_handle:
        for case in cases:
            ...
            response = post_json("https://api.anthropic.com/v1/messages", api_key, payload, args.timeout_seconds)
