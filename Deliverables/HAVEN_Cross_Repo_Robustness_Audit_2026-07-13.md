...
- that current CellScaffold `8fb2c059…` is green on the exact current
  CellProtocol `e180626…` dependency graph; two earlier dependency snapshots
